...
/**
 * IndependenceMergeTask merges given seqFiles into new ones, which basically consists of two steps:
 * 1. rearrange data and write to new file by device with old file deleted in this progress 2. close
 * files that can not be merged regularly
 */
